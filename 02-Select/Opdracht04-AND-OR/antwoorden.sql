...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/database/sql&db=mod-mysql-basic-fifa2018
   ...
   Weergave van records 0 -  5 (6 totaal, Query duurde 0,0008 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 24 (26 totaal, Query duurde 0,0007 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 12 (13 totaal, Query duurde 0,0014 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 24 (27 totaal, Query duurde 0,0007 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 -  4 (5 totaal, Query duurde 0,0014 seconden.)
...
-- Opdracht 9
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/sql&db=mod-mysql-basic-fifa2018&table=players&sql_query=SELECT+%2A+FROM+%60players%60++%0AORDER+BY+%60players%60.%60nationality%60+ASC&sql_signature=4f7616dc99f76e07ed527eab1d7249172bf8b647cee5bdc3c2aee0e045f5579e&session_max_rows=25&is_browse_distinct=0

   Weergave van records 0 -  8 (9 totaal, Query duurde 0,0009 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/sql&db=mod-mysql-basic-fifa2018&table=players&sql_query=SELECT+%2A+FROM+%60players%60++%0AORDER+BY+%60players%60.%60nationality%60+ASC&sql_signature=4f7616dc99f76e07ed527eab1d7249172bf8b647cee5bdc3c2aee0e045f5579e&session_max_rows=25&is_browse_distinct=0
   ...
   Weergave van records 0 - 24 (97 totaal, Query duurde 0,0009 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 24 (42 totaal, Query duurde 0,0006 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 24 (45 totaal, Query duurde 0,0007 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 15 (16 totaal, Query duurde 0,0006 seconden.)
...
127.0.0.1/mod-mysql-basic-fifa2018/players/		http://localhost/phpmyadmin/index.php?route=/table/sql&db=mod-mysql-basic-fifa2018&table=players
   ...
   Weergave van records 0 - 20 (21 totaal, Query duurde 0,0006 seconden.)
